...
-(void)setup
{
	...
	_gapWidth = 10;
	_diameter = 12;
	_pageControlStyle = PGPageControlStyleDfault;
...
- (void)drawRect:(CGRect)rect
{
    ...
    {
        if (self.pageControlStyle==PGPageControlStyleStrokedSquare || self.pageControlStyle==PGPageControlStyleStrokedCircle || self.pageControlStyle==PGPageControlStyleWithPageNumber)
        {
    ...
    {
        if (self.pageControlStyle==PGPageControlStyleDfault && self.coreNormalColor)
        {
    ...
    else
    {
        ...
        else if (self.pageControlStyle==PGPageControlStyleDfault && self.coreSelectedColor)
        {
    ...
    if (self.pageControlStyle==PGPageControlStyleThumb)
    {
...
//				total_width = self.numberOfPages*diameter + (self.numberOfPages-1)*gap;
	...
	for (i=0; i<self.numberOfPages; i++)
	{
        ...
        if (self.pageControlStyle==PGPageControlStyleDfault)
        {
        ...
        else if (self.pageControlStyle==PGPageControlStyleStrokedCircle)
        {
        ...
        else if (self.pageControlStyle==PGPageControlStyleStrokedSquare)
        {
            CGContextSetLineWidth(myContext, self.strokeWidth);
            if (i==self.currentPage)
            {
        ...
        else if (self.pageControlStyle==PGPageControlStyleWithPageNumber)
        {
            CGContextSetLineWidth(myContext, self.strokeWidth);
            if (i==self.currentPage)
            {
...
//                {
                    ...
                    NSDictionary *attributes = @{ NSFontAttributeName:[UIFont systemFontOfSize:_currentPageDiameter-2], NSParagraphStyleAttributeName:paragraphStyle };
...
//                }
        ...
        else if (self.pageControlStyle==PGPageControlStylePressed1 || self.pageControlStyle==PGPageControlStylePressed2)
        {
            if (self.pageControlStyle==PGPageControlStylePressed1)
            {
            ...
            else if (self.pageControlStyle==PGPageControlStylePressed2)
            {
        ...
        else if (self.pageControlStyle==PGPageControlStyleThumb)
        {
...
- (void)setPageControlStyle:(PGPageControlStyle)style
{
